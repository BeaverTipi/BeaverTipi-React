      ...
      <div className="mb-6 border p-8 rounded-xl bg-gray-50">
        ...
        <div className="grid grid-cols-3 gap-4 text-sm mb-4">
          <div className="col-span-1">
            ...
            <Input name="lessor" placeholder="임대인 성명" />
          </div>
          <div className="col-span-1">
            <label className="font-semibold">임차인(ㅇ):</label>
            <Input name="lessee" placeholder="임차인 성명" />
          </div>
          <div className="col-span-1">
        ...
        <div className="pt-5">
          ...
          <div className="grid grid-cols-4 gap-4 mb-2">
            ...
            <Input name="location" className="col-span-3" placeholder="도로명주소" />
          </div>
          <div className="grid grid-cols-4 gap-4 mb-2">
            <label className="col-span-1 font-semibold">토지 / 건물</label>
            <div className="col-span-1">
              <Input name="land" placeholder="지목" />
            </div>
            <div className="col-span-1">
              <Input name="structure" placeholder="구조·용도" />
            </div>
            <div className="col-span-1">
              <Input name="area" placeholder="면적(m²)" />
            </div>
          </div>
          <div className="grid grid-cols-4 gap-4 mb-2">
            <label className="col-span-1 font-semibold">임차부분</label>
            <Input name="rentedArea" className="col-span-3" placeholder="층수, 호수 등 상세" />
          </div>
        </div>
      </div>
    </ComponentCard>
