      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-y-2">
          <InfoItem
            label="공급면적"
            value={
              detail.lstgGArea != null ? `${detail.lstgGArea}㎡` : "정보 없음"
            }
          />
          <InfoItem
            label="전용면적"
            value={
              detail.lstgExArea != null ? `${detail.lstgExArea}㎡` : "정보 없음"
            }
          />
          <InfoItem
            label="보증금"
            value={
              detail.lstgLeaseAmt != null
                ? formatMoney(detail.lstgLeaseAmt)
                : "정보 없음"
            }
          />
          <InfoItem
            label="월세"
            value={
              detail.lstgLeaseM != null
                ? formatMoney(detail.lstgLeaseM)
                : "정보 없음"
            }
          />
          <InfoItem
            label="관리비"
            value={
              detail.lstgFee != null ? formatMoney(detail.lstgFee) : "없음"
            }
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-y-2">
          ...
          <InfoItem
            label="임대인이름"
            value={
              detail.tenancyInfo && detail.tenancyInfo.mbrNm
                ? detail.tenancyInfo.mbrNm
                : "정보 없음"
            }
          />
          <InfoItem
