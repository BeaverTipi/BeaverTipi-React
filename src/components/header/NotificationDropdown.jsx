              ...
              <li key={idx}>
                ...
                >
                  <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                    {notif.notifTypeCd === "001" ? (<InfoIcon />) : (<AlertHexaIcon />)}
                    {!notif.notifReadYn ? (
                      <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
                    ) : (
                      <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-gray-500 dark:border-gray-900"></span>
                    )}
                  </span>
